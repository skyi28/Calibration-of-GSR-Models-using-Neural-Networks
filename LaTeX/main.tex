...
\begin{table}[H]
	...
	\begin{threeparttable}
		\caption{\textbf{Overview of Utilized AI Models}}
		...
		\begin{tabular}{p{4cm} p{12cm}}
			...
			Codeium / Windsurf, \textit{Windsurf Chat Model (based on Meta’s Llama 3.1 70B)}, 2025, Version: Llama 3.1 70B, Used for coding assistance/autocompletion in the IDE as well as for the creation of Git commit messages, \url{https://codeium.com/windsurf}                                                                                                                                                                                                                       \\
